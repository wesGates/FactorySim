...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  ...
  __INIT_LOCATED(INT,__QW100,data__->DIGITALDISPLAY0,retain)
  __INIT_LOCATED_VALUE(data__->DIGITALDISPLAY0,0)
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->R_TRIG7.,CLK,,__GET_LOCATED(data__->RETROREFLECT4,));
  R_TRIG_body__(&data__->R_TRIG7);
  __SET_VAR(data__->RS2.,S,,__GET_VAR(data__->R_TRIG4.Q,));
  __SET_VAR(data__->RS2.,R1,,(((!(__GET_LOCATED(data__->EMERGENCYSTOP,)) || __GET_VAR(data__->R_TRIG5.Q,)) || __GET_VAR(data__->R_TRIG6.Q,)) || __GET_VAR(data__->R_TRIG7.Q,)));
  ...
  __SET_VAR(data__->R_TRIG24.,CLK,,__GET_LOCATED(data__->RETROREFLECT2,));
  R_TRIG_body__(&data__->R_TRIG24);
  __SET_VAR(data__->R_TRIG25.,CLK,,__GET_LOCATED(data__->RETROREFLECT4,));
  R_TRIG_body__(&data__->R_TRIG25);
  __SET_VAR(data__->RS10.,S,,(__GET_VAR(data__->F_TRIG6.Q,) && !(__GET_LOCATED(data__->LIGHTARRAY7SMALLBOX,))));
  __SET_VAR(data__->RS10.,R1,,(((!(__GET_LOCATED(data__->EMERGENCYSTOP,)) || __GET_VAR(data__->R_TRIG23.Q,)) || __GET_VAR(data__->R_TRIG24.Q,)) || __GET_VAR(data__->R_TRIG25.Q,)));

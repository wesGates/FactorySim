...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  ...
  __INIT_LOCATED(BOOL,__IX101_4,data__->RETROREFLECT4,retain)
  __INIT_LOCATED_VALUE(data__->RETROREFLECT4,__BOOL_LITERAL(FALSE))
  __INIT_LOCATED(BOOL,__IX101_5,data__->DIFFUSESENSOR0,retain)
  __INIT_LOCATED_VALUE(data__->DIFFUSESENSOR0,__BOOL_LITERAL(FALSE))
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->R_TRIG1.,CLK,,__GET_LOCATED(data__->FACTORYIORESET,));
  R_TRIG_body__(&data__->R_TRIG1);
  __SET_VAR(data__->RS0.,S,,__GET_LOCATED(data__->START,));
  __SET_VAR(data__->RS0.,R1,,(!(__GET_LOCATED(data__->EMERGENCYSTOP,)) || __GET_VAR(data__->R_TRIG1.Q,)));
  RS_body__(&data__->RS0);
  __SET_VAR(data__->R_TRIG2.,CLK,,__GET_LOCATED(data__->FACTORYIORESET,));
  R_TRIG_body__(&data__->R_TRIG2);
  __SET_VAR(data__->R_TRIG3.,CLK,,__GET_LOCATED(data__->TURNTABLEFRONTLIMIT,));
  R_TRIG_body__(&data__->R_TRIG3);
  __SET_VAR(data__->F_TRIG1.,CLK,,__GET_LOCATED(data__->RETROREFLECT1,));
  F_TRIG_body__(&data__->F_TRIG1);
  __SET_VAR(data__->R_TRIG4.,CLK,,__GET_LOCATED(data__->TURNTABLEBACKLIMIT,));
  R_TRIG_body__(&data__->R_TRIG4);
  __SET_VAR(data__->R_TRIG5.,CLK,,__GET_LOCATED(data__->RETROREFLECT2,));
  R_TRIG_body__(&data__->R_TRIG5);
  __SET_VAR(data__->R_TRIG6.,CLK,,__GET_LOCATED(data__->FACTORYIORESET,));
  R_TRIG_body__(&data__->R_TRIG6);
  __SET_VAR(data__->RS2.,S,,__GET_VAR(data__->R_TRIG4.Q,));
  __SET_VAR(data__->RS2.,R1,,((!(__GET_LOCATED(data__->EMERGENCYSTOP,)) || __GET_VAR(data__->R_TRIG5.Q,)) || __GET_VAR(data__->R_TRIG6.Q,)));
  ...
  __SET_VAR(data__->RS1.,R1,,(((!(__GET_LOCATED(data__->RETROREFLECT0,)) && ((__GET_VAR(data__->F_TRIG1.Q,) || __GET_VAR(data__->RS2.Q1,)) || __GET_VAR(data__->R_TRIG3.Q,))) || !(__GET_LOCATED(data__->EMERGENCYSTOP,))) || __GET_VAR(data__->R_TRIG2.Q,)));
  ...
  __SET_VAR(data__->RS3.,R1,,((__GET_VAR(data__->F_TRIG3.Q,) || !(__GET_LOCATED(data__->EMERGENCYSTOP,))) || __GET_VAR(data__->R_TRIG7.Q,)));
  RS_body__(&data__->RS3);
  __SET_VAR(data__->,SMALLBOX,,__GET_VAR(data__->RS3.Q1,));
  __SET_VAR(data__->R_TRIG8.,CLK,,__GET_LOCATED(data__->START,));
  R_TRIG_body__(&data__->R_TRIG8);
  __SET_VAR(data__->R_TRIG9.,CLK,,__GET_LOCATED(data__->FACTORYIORESET,));
  R_TRIG_body__(&data__->R_TRIG9);
  __SET_VAR(data__->R_TRIG10.,CLK,,__GET_LOCATED(data__->TURNTABLEFRONTLIMIT,));
  R_TRIG_body__(&data__->R_TRIG10);
  __SET_VAR(data__->RS4.,S,,__GET_VAR(data__->R_TRIG8.Q,));
  __SET_VAR(data__->RS4.,R1,,((!(__GET_LOCATED(data__->EMERGENCYSTOP,)) || __GET_VAR(data__->R_TRIG10.Q,)) || __GET_VAR(data__->R_TRIG9.Q,)));
  RS_body__(&data__->RS4);
  __SET_VAR(data__->F_TRIG4.,CLK,,__GET_LOCATED(data__->RETROREFLECT1,));
  F_TRIG_body__(&data__->F_TRIG4);
  __SET_VAR(data__->R_TRIG11.,CLK,,__GET_LOCATED(data__->FACTORYIORESET,));
  R_TRIG_body__(&data__->R_TRIG11);
  __SET_VAR(data__->R_TRIG12.,CLK,,__GET_LOCATED(data__->TURNTABLEFRONTLIMIT,));
  R_TRIG_body__(&data__->R_TRIG12);
  __SET_VAR(data__->RS5.,S,,(__GET_LOCATED(data__->EMERGENCYSTOP,) && ((((__GET_VAR(data__->MATERIAL,) && __GET_LOCATED(data__->TURNTABLELIMIT0,)) || (__GET_VAR(data__->SMALLBOX,) && __GET_LOCATED(data__->TURNTABLELIMIT90,))) || (__GET_LOCATED(data__->TURNTABLE0TURN,) && __GET_VAR(data__->F_TRIG4.Q,))) || __GET_VAR(data__->RS4.Q1,))));
  __SET_VAR(data__->RS5.,R1,,((!(__GET_LOCATED(data__->EMERGENCYSTOP,)) || __GET_VAR(data__->R_TRIG11.Q,)) || __GET_VAR(data__->R_TRIG12.Q,)));
  ...
  __SET_VAR(data__->R_TRIG13.,CLK,,__GET_LOCATED(data__->FACTORYIORESET,));
  R_TRIG_body__(&data__->R_TRIG13);
  __SET_VAR(data__->R_TRIG14.,CLK,,__GET_LOCATED(data__->RETROREFLECT2,));
  R_TRIG_body__(&data__->R_TRIG14);
  __SET_VAR(data__->RS6.,S,,(__GET_VAR(data__->F_TRIG5.Q,) && __GET_VAR(data__->SMALLBOX,)));
  __SET_VAR(data__->RS6.,R1,,(__GET_VAR(data__->R_TRIG13.Q,) || __GET_VAR(data__->R_TRIG14.Q,)));
  RS_body__(&data__->RS6);
  __SET_VAR(data__->R_TRIG15.,CLK,,__GET_LOCATED(data__->FACTORYIORESET,));
  R_TRIG_body__(&data__->R_TRIG15);
  __SET_VAR(data__->R_TRIG16.,CLK,,__GET_LOCATED(data__->RETROREFLECT2,));
  R_TRIG_body__(&data__->R_TRIG16);
  __SET_VAR(data__->RS7.,S,,(__GET_LOCATED(data__->TURNTABLEFRONTLIMIT,) && __GET_VAR(data__->RS6.Q1,)));
  __SET_VAR(data__->RS7.,R1,,(__GET_VAR(data__->R_TRIG15.Q,) || __GET_VAR(data__->R_TRIG16.Q,)));
  RS_body__(&data__->RS7);
  __SET_LOCATED(data__->,TURNTABLE0TURN,,__GET_VAR(data__->RS7.Q1,));
  __SET_VAR(data__->R_TRIG17.,CLK,,__GET_LOCATED(data__->START,));
  R_TRIG_body__(&data__->R_TRIG17);
  __SET_VAR(data__->R_TRIG18.,CLK,,__GET_LOCATED(data__->RETROREFLECT3,));
  R_TRIG_body__(&data__->R_TRIG18);
  __SET_VAR(data__->R_TRIG19.,CLK,,__GET_LOCATED(data__->FACTORYIORESET,));
  R_TRIG_body__(&data__->R_TRIG19);
  __SET_VAR(data__->RS8.,S,,__GET_VAR(data__->R_TRIG17.Q,));
  __SET_VAR(data__->RS8.,R1,,((!(__GET_LOCATED(data__->EMERGENCYSTOP,)) || __GET_VAR(data__->R_TRIG18.Q,)) || __GET_VAR(data__->R_TRIG19.Q,)));
  RS_body__(&data__->RS8);
  __SET_VAR(data__->R_TRIG20.,CLK,,__GET_LOCATED(data__->RETROREFLECT3,));
  R_TRIG_body__(&data__->R_TRIG20);
  __SET_VAR(data__->R_TRIG21.,CLK,,__GET_LOCATED(data__->FACTORYIORESET,));
  ...
  __SET_VAR(data__->RS9.,R1,,((!(__GET_LOCATED(data__->EMERGENCYSTOP,)) || __GET_VAR(data__->R_TRIG20.Q,)) || __GET_VAR(data__->R_TRIG21.Q,)));
  ...
  __SET_VAR(data__->RS10.,R1,,((__GET_VAR(data__->F_TRIG7.Q,) || !(__GET_LOCATED(data__->EMERGENCYSTOP,))) || __GET_VAR(data__->R_TRIG22.Q,)));
